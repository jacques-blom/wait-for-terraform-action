...
var TF_API_BASE = "https://app.terraform.io";
var getLatestRun = function (_a) {
    var organization = _a.organization, workspace = _a.workspace, token = _a.token;
    return __awaiter(void 0, void 0, void 0, function () {
        var workspaceData, latestRun, latestRunData;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, tfAPICall(token, "/api/v2/organizations/".concat(organization, "/workspaces/").concat(workspace))];
                case 1:
                    workspaceData = _c.sent();
                    latestRun = (_b = workspaceData === null || workspaceData === void 0 ? void 0 : workspaceData.relationships) === null || _b === void 0 ? void 0 : _b["latest-run"];
                    if (!latestRun) {
                        console.warn("No runs associated with workspace '".concat(workspace, "'"));
                        return [2 /*return*/];
                    }
...
var wait = function (_a) {
    var organization = _a.organization, workspaces = _a.workspaces, token = _a.token, _b = _a.waitForApply, waitForApply = _b === void 0 ? false : _b;
    return __awaiter(void 0, void 0, void 0, function () {
        var workspacesArray;
        return __generator(this, function (_c) {
            switch (_c.label) {
                    ...
                    return [4 /*yield*/, runUntilTrue(function () { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        statuses = [];
                                        _i = 0, workspacesArray_1 = workspacesArray;
                                        _b.label = 1;
                                    case 1:
                                        if (!(_i < workspacesArray_1.length)) return [3 /*break*/, 4];
                                        workspace = workspacesArray_1[_i];
                                        return [4 /*yield*/, getLatestRun({
                                    ...
                                    case 4:
                                        ...
                                        busyCount = statuses.filter(function (s) { return !s.done; }).length;
                                        if (busyCount > 0) {
                                            console.log("");
                                            console.log("Waiting for the following workspaces:");
                                            for (_a = 0, statuses_1 = statuses; _a < statuses_1.length; _a++) {
                                                status = statuses_1[_a];
                                                console.log("\u2022 ".concat(status.workspace, ": ").concat(status.status));
                                            }
                                        }
                                        else {
...
var runUntilTrue = function (run, delay) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, runUntilTrue(run, delay)];
                case 3:
                    _a.sent();
                    _a.label = 4;
...
function tfAPICall(token, path, config) {
    return __awaiter(this, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_default()(TF_API_BASE + path, __assign(__assign({}, config), { headers: __assign(__assign({}, config === null || config === void 0 ? void 0 : config.headers), { Authorization: "Bearer ".concat(token), "Content-Type": "application/vnd.api+json" }) })).catch(catchAxiosError)];
                case 1:
                    data = (_a.sent()).data;
...
var catchAxiosError = function (error) {
    var _a, _b;
    if (((_a = error.response) === null || _a === void 0 ? void 0 : _a.status) === 401) {
        throw new Error("401 - Unauthorized. Please make sure the token is correct.");
    }
    else if (((_b = error.response) === null || _b === void 0 ? void 0 : _b.status) === 404) {
        throw new Error("Could not find your workspace. Please make sure the organization, workspace names are correct.");
    }
    else {
        throw error;
    }
...
var run = function () { return main_awaiter(void 0, void 0, void 0, function () {
    var organization, workspaces, token, waitForApply;
    return main_generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                waitForApply = core.getInput("waitForApply") === "true";
                return [4 /*yield*/, wait({
                        organization: organization,
                        workspaces: workspaces,
                        token: token,
                        waitForApply: waitForApply,
                    })];
            case 1:
                _a.sent();
                return [2 /*return*/];
